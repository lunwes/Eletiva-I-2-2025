<?php
    ...
    echo "<p>Caracter E na posição $posicao</p>";
    ...
    $valor = 5.9;
    echo "Valor arredondado:".round($valor)."</p>";
    $valor = rand(1, 100);
    ...
    function exibirSaudacaoComNome($nome){
        echo "<p>Seja bem vindo(a)/(e) $nome</p>";
    }

    exibirSaudacaoComNome($nome);

    function menorValor($valor1, $valor2){
        return min($valor1, $valor2);
    }

    echo "<p>Menor valor entre 4 e 8: ".menorValor(4, 8),"</p>";
