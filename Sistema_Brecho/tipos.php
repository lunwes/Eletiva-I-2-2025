...
<h2 class="mb-5" style="color: #8d6a4eff">Tipos de Roupas</h2>
        ...
        <?php foreach ($dados as $d): ?>
            <tr>
                ...
                <td class="d-flex gap-3">
                    <a href="editar_tipos.php?id=<?= $d['idtipo'] ?>" data-bs-toggle="tooltip" title="Editar">
                        <i class="bi bi-pencil-square icone-acao"></i>
                    </a>
                    <a href="consultar_tipos.php?id=<?= $d['idtipo'] ?>" data-bs-toggle="tooltip" title="Consultar">
...
<div class="text-end">
    <a href="novo_tipo.php" data-bs-toggle="tooltip" title="Novo" class="botao-novo">
